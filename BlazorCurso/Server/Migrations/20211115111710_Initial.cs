        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AntecedentesPersonales = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AlergiasMedicamentosas = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Consultas_Seguimientos_SeguimientoId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SeguimientoId = table.Column<int>(type: "int", nullable: false),
                    TipoProblemaId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Problemas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Problemas_Seguimientos_SeguimientoId",
                        column: x => x.SeguimientoId,
                        principalTable: "Seguimientos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Problemas_Valores_TipoProblemaId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TipoPruebaId = table.Column<int>(type: "int", nullable: false),
                    Fecha = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pruebas_Seguimientos_SeguimientoId",
                        column: x => x.SeguimientoId,
                        principalTable: "Seguimientos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Pruebas_Valores_TipoPruebaId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Documentos_Pruebas_PruebaId",
                        column: x => x.PruebaId,
                        principalTable: "Pruebas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Documentos_Valores_TipoDocumentoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Consultas_SeguimientoId",
                table: "Consultas",
                column: "SeguimientoId");

            migrationBuilder.CreateIndex(
                name: "IX_Documentos_PruebaId",
                table: "Documentos",
                column: "PruebaId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Problemas_SeguimientoId",
                table: "Problemas",
                column: "SeguimientoId");

            migrationBuilder.CreateIndex(
                name: "IX_Problemas_TipoProblemaId",
                table: "Problemas",
                column: "TipoProblemaId");

            migrationBuilder.CreateIndex(
                name: "IX_Pruebas_SeguimientoId",
                table: "Pruebas",
                column: "SeguimientoId");

            migrationBuilder.CreateIndex(
                name: "IX_Pruebas_TipoPruebaId",
                table: "Pruebas",
                column: "TipoPruebaId");
